...
**NOTE** The keyword SUM can be used to draw a sum of all samples with DOSUM=TRUE with a statistical error band. Add it as 
just another sample in the sample configuration file. 
